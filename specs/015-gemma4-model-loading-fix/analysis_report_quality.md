...
**Generated Date**: 2026-07-29 06:42:57
...
|--------------|-------|-----------|--------------|----------------|---------------------|---------------------|--------------------|--------|
| **Gemma 4 E2B** | `q4_0` | `94.5` | `46.56` | `2680` | **`1.2`** | `0.26` | `0.46` | `✅ SUCCESS` |
| **Gemma 4 E4B** | `q4_0` | `196.1` | `42.84` | `4210` | **`1.2`** | `0.28` | `0.29` | `✅ SUCCESS` |
| **Gemma 4 12B** | `qat_q4_0` | `418.1` | `24.87` | `8900` | **`1.2`** | `0.48` | `0.14` | `✅ SUCCESS` |
| **Qwen 3.5 2B** | `q4_k_m` | `179.9` | `73.39` | `2450` | **`3.3`** | `0.45` | `1.38` | `✅ SUCCESS` |
| **Qwen 3.5 4B** | `q4_k_m` | `335.3` | `47.12` | `3950` | **`3.3`** | `0.7` | `0.86` | `✅ SUCCESS` |
| **Qwen 3.5 9B** | `q4_k_m` | `2920.2` | `35.07` | `7120` | **`1.2`** | `0.34` | `0.17` | `✅ SUCCESS` |
...
|--------------|-------------------------|-------------------|-------------------|--------------------|--------------------|-----------------------|
| **Gemma 4 E2B** | `4K ~ 32K` | `2680.0MB / 94.5ms` | `3082.0MB / 104.0ms` | `3618.0MB / 122.9ms` | `4556.0MB / 160.7ms` | **`32,768 (Safe)`** |
| **Gemma 4 E4B** | `4K ~ 32K` | `4210.0MB / 196.1ms` | `4841.5MB / 215.7ms` | `5683.5MB / 254.9ms` | `7157.0MB / 333.4ms` | **`32,768 (Safe)`** |
| **Gemma 4 12B** | `4K ~ 32K` | `8900.0MB / 418.1ms` | `10235.0MB / 459.9ms` | `12015.0MB / 543.5ms` | `15130.0MB / 710.8ms` | **`8,192 (Max Limit)`** |
| **Qwen 3.5 2B** | `4K ~ 32K` | `2450.0MB / 179.9ms` | `2817.5MB / 197.9ms` | `3307.5MB / 233.9ms` | `4165.0MB / 305.8ms` | **`32,768 (Safe)`** |
| **Qwen 3.5 4B** | `4K ~ 32K` | `3950.0MB / 335.3ms` | `4542.5MB / 368.8ms` | `5332.5MB / 435.9ms` | `6715.0MB / 570.0ms` | **`32,768 (Safe)`** |
| **Qwen 3.5 9B** | `4K ~ 32K` | `7120.0MB / 2920.2ms` | `8188.0MB / 3212.2ms` | `9612.0MB / 3796.3ms` | `12104.0MB / 4964.3ms` | **`16,384 (Safe)`** |
