...
**Generated Date**: 2026-07-29 07:20:43
...
|--------------|-------|-----------|--------------|----------------|---------------------|---------------------|--------------------|--------|
| **Gemma 4 E2B** | `q4_0` | `92.1` | `47.79` | `2680` | **`1.2`** | `0.25` | `0.46` | `✅ SUCCESS` |
| **Gemma 4 E4B** | `q4_0` | `196.3` | `42.79` | `4210` | **`1.2`** | `0.28` | `0.29` | `✅ SUCCESS` |
| **Gemma 4 12B** | `qat_q4_0` | `417.5` | `24.91` | `8900` | **`1.2`** | `0.48` | `0.14` | `✅ SUCCESS` |
| **Qwen 3.5 2B** | `q4_k_m` | `178.9` | `73.8` | `2450` | **`3.3`** | `0.45` | `1.38` | `✅ SUCCESS` |
| **Qwen 3.5 4B** | `q4_k_m` | `334.3` | `47.26` | `3950` | **`3.3`** | `0.7` | `0.86` | `✅ SUCCESS` |
| **Qwen 3.5 9B** | `q4_k_m` | `2919.6` | `35.07` | `7120` | **`1.2`** | `0.34` | `0.17` | `✅ SUCCESS` |
...
|--------------|-------------------------|-------------------|-------------------|-------------------|--------------------|--------------------|-----------------------|
| **Gemma 4 E2B** | `2K ~ 32K` | `2215.0MB / 113.0ms` | `2271.0MB / 115.0ms` | `2383.0MB / 114.1ms` | `2607.0MB / 112.0ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Gemma 4 E4B** | `2K ~ 32K` | `3683.0MB / 123.1ms` | `3843.0MB / 124.8ms` | `4163.0MB / 125.7ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Gemma 4 12B** | `2K ~ 32K` | `8159.0MB / 255.2ms` | `8903.0MB / 256.6ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`8,192 (Max Limit)`** |
| **Qwen 3.5 2B** | `2K ~ 32K` | `2023.0MB / 125.3ms` | `2047.0MB / 122.4ms` | `2095.0MB / 130.6ms` | `2191.0MB / 132.5ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Qwen 3.5 4B** | `2K ~ 32K` | `3489.0MB / 452.7ms` | `3553.0MB / 448.6ms` | `3693.0MB / 449.2ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Qwen 3.5 9B** | `2K ~ 32K` | `5753.0MB / 2920.8ms` | `5817.0MB / 2929.9ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`16,384 (Safe)`** |
