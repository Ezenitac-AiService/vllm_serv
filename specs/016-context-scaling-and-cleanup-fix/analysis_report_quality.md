...
**Generated Date**: 2026-07-29 07:14:09
...
|--------------|-------|-----------|--------------|----------------|---------------------|---------------------|--------------------|--------|
| **Gemma 4 E2B** | `q4_0` | `93.5` | `47.07` | `2680` | **`1.2`** | `0.25` | `0.46` | `✅ SUCCESS` |
| **Gemma 4 E4B** | `q4_0` | `203.3` | `41.32` | `4210` | **`1.2`** | `0.29` | `0.29` | `✅ SUCCESS` |
| **Gemma 4 12B** | `qat_q4_0` | `417.7` | `24.9` | `8900` | **`1.2`** | `0.48` | `0.14` | `✅ SUCCESS` |
| **Qwen 3.5 2B** | `q4_k_m` | `184.4` | `71.58` | `2450` | **`3.3`** | `0.46` | `1.38` | `✅ SUCCESS` |
| **Qwen 3.5 4B** | `q4_k_m` | `334.8` | `47.19` | `3950` | **`3.3`** | `0.7` | `0.86` | `✅ SUCCESS` |
| **Qwen 3.5 9B** | `q4_k_m` | `2919.1` | `35.08` | `7120` | **`1.2`** | `0.34` | `0.17` | `✅ SUCCESS` |
...
|--------------|-------------------------|-------------------|-------------------|-------------------|--------------------|--------------------|-----------------------|
| **Gemma 4 E2B** | `2K ~ 32K` | `2215.0MB / 114.3ms` | `2271.0MB / 116.5ms` | `2383.0MB / 109.4ms` | `2607.0MB / 118.0ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Gemma 4 E4B** | `2K ~ 32K` | `3683.0MB / 121.8ms` | `3843.0MB / 123.0ms` | `4163.0MB / 123.4ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Gemma 4 12B** | `2K ~ 32K` | `8159.0MB / 257.5ms` | `8903.0MB / 255.3ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`8,192 (Max Limit)`** |
| **Qwen 3.5 2B** | `2K ~ 32K` | `2023.0MB / 126.8ms` | `2047.0MB / 125.3ms` | `2095.0MB / 124.7ms` | `2191.0MB / 125.9ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Qwen 3.5 4B** | `2K ~ 32K` | `3489.0MB / 449.1ms` | `3553.0MB / 455.3ms` | `3693.0MB / 445.4ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`32,768 (Safe)`** |
| **Qwen 3.5 9B** | `2K ~ 32K` | `5753.0MB / 2925.6ms` | `5817.0MB / 2929.3ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | `0.0MB / 0.0ms` | **`16,384 (Safe)`** |
