"""sample_09_reranking.py
================================================================================
[9단계 실습] httpx 기반 BGE-Reranker v2 Cross-Encoder 관련도 재순위화 (5종 후보 문서)
================================================================================
학습 목표:
1. BGE-Reranker v2 전용 서비스 데몬(포트 8091)에 사용자 질문과 후보 문서 5개를 전송합니다.
2. 질문과 의미적 유사도가 높은 관련 문서 3개와 관련 없는 노이즈 문서 2개(총 5개 후보 문서)를 재순위화(Re-ranking)하여 상위 문서만을 도출하는 파이프라인을 구축합니다.
...
def main():
    print_section_header("09. httpx BGE-Reranker v2 (5종 후보 문서 재순위화) 실습")
    ...
    try:
        with get_httpx_client() as client:
            ...
            print_performance_summary("BGE-Reranker 5종 재순위화", t_start, t_end)
