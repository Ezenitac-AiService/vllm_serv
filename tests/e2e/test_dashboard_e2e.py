"""
Playwright & Physical Host IP E2E Dashboard UI/UX Usability Test Suite (038-server-firewall-setup-pipeline).
Strictly obeys Constitution v1.3.1 (No Mocks, Real Physical Host IP 10.0.0.41 Socket & Web UI Verification).
"""
