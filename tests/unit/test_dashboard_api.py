...
def test_dashboard_capabilities_public():
...
def test_dashboard_apply_unauthorized_returns_401():
...
def test_dashboard_apply_with_valid_admin_secret():
...
def test_dashboard_playground_test_execution():
